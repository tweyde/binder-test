---
title: 'Chapter 18 Interactive Notebook for Instructors'
...
```
## Partition Data
* Note the use of sample() function and sapply() to simplify the coding. Could be useful to explain to students the use of apply() functions in R.
```{r}
set.seed(123456)
N = nrow(dataset)
cut1 = floor(0.6*N)
