---
title: 'Chapter 18: Regression Models in Machine Learning'
...
val_pred = predict(lr,newdata = df_val[-11])
test_pred = predict(lr,newdata = df_test[-11])
```
...
* Run the lasso model with the tuned lambda parameter
```{r}
