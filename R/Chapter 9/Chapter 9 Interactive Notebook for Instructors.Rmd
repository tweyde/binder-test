---
title: 'Chapter 9: Interactive Notebook for Instructors'
...
head(admission) 
```
* It would be an interesting exercise for students to run a variety of statistical tests on both original and synthetic data, and compare performance.
