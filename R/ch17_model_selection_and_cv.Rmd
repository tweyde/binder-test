...
print(paste0("KNN LOOCV Mean Accuracy: ", fit_knn_20fold$results$Accuracy))
print(paste0("KNN LOOCV Accuracy Standard Deviation: ", fit_knn_20fold$results$AccuracySD))
```
...
wilcox.test(fit_dt_20fold$resample$Accuracy, fit_knn_20fold$resample$Accuracy, alternative = "two.sided")
